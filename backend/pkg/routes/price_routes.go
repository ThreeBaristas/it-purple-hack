...
func PriceRoutes(a *fiber.App, cR *repository.CategoriesRepositoryImpl, lR *repository.LocationsRepositoryImpl, pR *repository.PriceRepository, storage *repository.MatricesMappingStorage) {
